...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff7d7d90;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xffe0e0f6;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] {0x00000000, 0x00000000, 0x00000000};/*{ 0xFF111111,
			0x00AAAAAA, 0x00AAAAAA };*/

	/** Additional items height (is added to standard text item height) */
	private static final int ADDITIONAL_ITEM_HEIGHT = 75;//15
	...
	/** Label offset */
	private static final int LABEL_OFFSET = 8;//8
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.timer_lins_img);
		}

		if (topShadow == null) {
			topShadow = new GradientDrawable(Orientation.BOTTOM_TOP,//TOP_BOTTOM
					SHADOWS_COLORS);
		}

		if (bottomShadow == null) {
			bottomShadow = new GradientDrawable(Orientation.TOP_BOTTOM,//BOTTOM_TOP,
					SHADOWS_COLORS);
		}

		setBackgroundResource(R.color.dialogb_color);
	}
