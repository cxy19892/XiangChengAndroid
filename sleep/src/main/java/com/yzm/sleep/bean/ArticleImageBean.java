...
public class ArticleImageBean implements Serializable{
	...
	private String content_attachment;     //原图地址；
	private String t_attachment_key;      //原图图片key；
	private String content_attachment_sl;    //缩略图地址；
	private String t_attachment_key_sl;       //缩略图key
