...
public class FourCornersRoundAngleImageView extends ImageView {
	...
	public FourCornersRoundAngleImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context, attrs);
	}

	public FourCornersRoundAngleImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}

	public FourCornersRoundAngleImageView(Context context) {
		super(context);
		init(context, null);
	}
