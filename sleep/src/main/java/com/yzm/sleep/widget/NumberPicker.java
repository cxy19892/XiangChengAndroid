...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDERS_DISTANCE = 24;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInputText.setTextColor(0xff999999);
...
//        mInputText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE) {
                canvas.drawText(format(scrollSelectorValue), x, y, mSelectorWheelPaint);
            }
    ...
    private boolean updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
            mInputText.setText(format(text));
            return true;
        }
