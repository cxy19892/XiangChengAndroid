...
public class ColorFullRoundProgressBar extends View {
	/** 画笔对象的引用 */
	private Paint paint;
	/** 圆环的颜色 */
	...
	public ColorFullRoundProgressBar(Context context) {
		this(context, null);
		this.context = context;
		getDensity();
	}

	public ColorFullRoundProgressBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.context = context;
		getDensity();
	}

	public ColorFullRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setColor(int bgcolors, int procolors){
		roundColor = bgcolors;
		roundProgressColor = procolors;
		textColor = procolors;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(Color.parseColor("#00000000")); // 设置进度的颜色
		paint.setStyle(Style.FILL);// 设置圆环为实心
		...
		paint.setStyle(Style.STROKE);// 设置圆环为空心
