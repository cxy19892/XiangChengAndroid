...
public class SpeRollPickerDialog extends AlertDialog implements android.view.View.OnClickListener, OnWheelChangedListener{
	...
	protected SpeRollPickerDialog(Context context, int theme) {
//		super(context, R.style.add_dialog);
	 ...
	 * @param callBack
	 */
	public SpeRollPickerDialog(Context context, RollCallBack callBack){
		super(context,R.style.pop_dialog);
//		super(context, R.style.add_dialog);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_roll_picker_spe);
